...
After going to the link please ensure that your kaggle account has verified phone number in oreder to access the dataset.

After that in your account you can create a api token which can be used for model development

In this im using Google Colab for the model development
For the main code you can click the Dog VS Cat classifiaction using Transfer learning in the repository
